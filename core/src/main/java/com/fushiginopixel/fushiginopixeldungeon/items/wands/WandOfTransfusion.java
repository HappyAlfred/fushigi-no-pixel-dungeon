	...
	protected void onZap(Ballistica beam) {
		...
		if (ch != null && ch instanceof Mob){
			...
			//harms the undead
				...
				ch.damage(damage, this, new EffectType(EffectType.BEAM,EffectType.LIGHT));
			...
			//charms an enemy
				...
				Buff.affect(curUser, Charm.class, duration, new EffectType(0,EffectType.SPIRIT)).object = ch.id();
