...
public class Potion extends Item {
	...
	private static final HashMap<String, Integer> colors = new HashMap<String, Integer>() {
		{
			...
			put("chromeyellow",ItemSpriteSheet.POTION_CHROMEYELLOW);
			put("jade",ItemSpriteSheet.POTION_JADE);
			put("soda",ItemSpriteSheet.POTION_SODA);
			...
			put("copper",ItemSpriteSheet.POTION_COPPER);
			put("turquoise",ItemSpriteSheet.POTION_TURQUOISE);
			put("ermine",ItemSpriteSheet.POTION_ERMINE);
			put("steelblue",ItemSpriteSheet.POTION_STEELBLUE);
			put("salmon",ItemSpriteSheet.POTION_SALMON);
	...
	@Override
	public String name() {
		return isKnown() || !guessedName.equals("")  ? super.name() : Messages.get(Potion.class, color);
	}
