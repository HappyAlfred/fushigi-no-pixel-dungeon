...
import com.fushiginopixel.fushiginopixeldungeon.actors.mobs.FlareDragon;
...
public class FlareDragonSprite extends MobSprite {
	...
	public void zap( int cell ) {
		...
		turnTo( ch.pos , cell );
		play( zap );
		final Ballistica shot = new Ballistica( ch.pos, cell, Ballistica.STOP_TARGET);
		...
		MagicMissile.boltFromChar( parent,
				...
				new Callback() {
					@Override
					public void call() {
						((FlareDragon)ch).onZapComplete(shot);
					}
				} );
