...
public class ItemSpriteSheet {
	...
	private static final int WIDTH = 32;//pincture length/16
	private static final int WIDTH1 = 16;//film length
	...
	public static final int POT_HOLDER       = PLACEHOLDERS+8;
	public static final int SOMETHING       = PLACEHOLDERS+9;
	public static final int BLANK       	= PLACEHOLDERS+15;
	static{
		...
		assignItemRect(POT_HOLDER,   10, 12);
		assignItemRect(SOMETHING,       8,  13);
		assignItemRect(BLANK,       16,  16);
	}
	...
	private static final int SINGLE_USE     =                               xy(1, 4);   //32 slots
	...
	public static final int FIREWORK          = SINGLE_USE+16;
	public static final int CANNONBALL          = SINGLE_USE+17;
	public static final int GEL          = SINGLE_USE+18;
	static{
		...
		assignItemRect(FIREWORK,          12, 13);
		assignItemRect(CANNONBALL,          10, 10);
		assignItemRect(GEL,          10, 10);
	}
	...
	public static final int SWORD           = WEP_TIER1+1;
	public static final int LONGSWORD       = WEP_TIER1+2;
	public static final int GREATSWORD      = WEP_TIER1+3;
	//public static final int CUDGEL          = WEP_TIER1+1;
	public static final int KNUCKLEDUSTER   = WEP_TIER1+4;
	//public static final int RAPIER          = WEP_TIER1+3;
	public static final int DAGGER          = WEP_TIER1+5;
	public static final int MAGES_STAFF     = WEP_TIER1+6;
	static{
	...
	public static final int GOLDSWORD            = WEP_TIER2+3;
	public static final int MACE            = WEP_TIER2+4;
	public static final int SCIMITAR        = WEP_TIER2+5;
	public static final int ROUND_SHIELD    = WEP_TIER2+6;
	static{
		assignItemRect(HAND_AXE,        12, 14);
		assignItemRect(SPEAR,           16, 16);
		assignItemRect(QUARTERSTAFF,    16, 16);
		assignItemRect(GOLDSWORD,            13, 13);
	...
	public static final int MATTOCK            = WEP_TIER3+0;
	public static final int SAI             = WEP_TIER3+1;
	public static final int WHIP            = WEP_TIER3+2;
	public static final int KATANA            = WEP_TIER3+3;
	public static final int ASSASSINS_BLADE = WEP_TIER3+4;
	public static final int CROSSBOW        = WEP_TIER3+5;
	public static final int FLAIL           = WEP_TIER3+6;
	static{
		assignItemRect(MATTOCK,            14, 12);
	...
	public static final int GREATAXE        = WEP_TIER4+3;
	...
	public static final int RUNIC_BLADE     = WEP_TIER5+0;
	public static final int INFERNO_FUHMA_KATANA       = WEP_TIER5+1;
	public static final int GRADIUS       = WEP_TIER5+2;
	static{
		assignItemRect(RUNIC_BLADE,     14, 14);
		assignItemRect(INFERNO_FUHMA_KATANA,     15, 16);
		assignItemRect(GRADIUS,     15, 15);
	}

	                                                                                    //8 free slots

	private static final int MISSILE_WEP    =                               xy(1, 9);  //16 slots. 3 per tier + boomerang
	...
	public static final int TIPPED_DARTS    =                               xy(1, 10);  //16 slots
	...
	private static final int ARMOR_TIER1          =                               xy(1, 11);  //8 slots
	public static final int ARMOR_CLOTH     = ARMOR_TIER1+0;
    public static final int SILK_SUIT     = ARMOR_TIER1+1;
	static{
		assignItemRect(ARMOR_CLOTH,     15, 12);
        assignItemRect(SILK_SUIT,     14, 12);
	}

	private static final int ARMOR_TIER2          =                               xy(9, 11);  //8 slots
	public static final int ARMOR_LEATHER   = ARMOR_TIER2+0;
	public static final int ARMOR_WOODEN  	= ARMOR_TIER2+1;
	public static final int ARMOR_GOLD  	= ARMOR_TIER2+2;
	static{
		assignItemRect(ARMOR_LEATHER,   14, 13);
		assignItemRect(ARMOR_WOODEN,  14, 12);
		assignItemRect(ARMOR_GOLD,  12, 12);
	}

	private static final int ARMOR_TIER3          =                               xy(1, 12);  //8 slots
	public static final int ARMOR_MAIL   = ARMOR_TIER3+0;
	public static final int ARMOR_LEAF   = ARMOR_TIER3+1;
	public static final int ARMOR_CANE   = ARMOR_TIER3+2;
	static{
		assignItemRect(ARMOR_MAIL,      14, 12);
		assignItemRect(ARMOR_LEAF,      14, 13);
		assignItemRect(ARMOR_CANE,      15, 12);
	}
	...
	public static final int ARMOR_PLATE   = ARMOR_TIER5+0;
	static{
		assignItemRect(ARMOR_PLATE,      12, 12);
	}

	private static final int ARMOR_CLASS          =                               xy(9, 13);  //8 slots
	public static final int ARMOR_WARRIOR   = ARMOR_CLASS+0;
	public static final int ARMOR_MAGE      = ARMOR_CLASS+1;
	public static final int ARMOR_ROGUE     = ARMOR_CLASS+2;
	public static final int ARMOR_HUNTRESS  = ARMOR_CLASS+3;
	static{
	...
	public static final int SCROLL_ZAROI   = SCROLLS+12;
	public static final int SCROLL_ULRAL = SCROLLS+13;
	public static final int SCROLL_CERSCEN = SCROLLS+14;
	public static final int SCROLL_DAEKMAZ     = SCROLLS+15;
	public static final int SCROLL_HENAZO    = SCROLLS+16;
	public static final int SCROLL_ESOLOZ    = SCROLLS+17;
	...
	public static final int POTION_CHROMEYELLOW   = POTIONS+2;
	public static final int POTION_JADE     = POTIONS+3;
	public static final int POTION_SODA	= POTIONS+4;
	...
	public static final int POTION_COPPER   = POTIONS+12;
	public static final int POTION_TURQUOISE= POTIONS+13;
	public static final int POTION_ERMINE	 = POTIONS+14;
	public static final int POTION_STEELBLUE= POTIONS+15;
	public static final int POTION_SALMON   = POTIONS+16;
	public static final int POTION_GOLDEN   = POTIONS+17;
	static {
		for (int i = POTIONS; i < POTIONS+18; i++)
	...
	private static final int POTS        =                               xy(1, 24);  //16 slots
	public static final int POT_LONG  = POTS+0;
	public static final int POT_WIDE    = POTS+1;
	public static final int POT_NARROWMOUTH   = POTS+2;
	public static final int POT_GLOBOSE     = POTS+3;
	public static final int POT_TRIANGULAR= POTS+4;
	public static final int POT_THINNECK    = POTS+5;
	public static final int POT_NORMAL   = POTS+6;
	public static final int POT_SMALL  = POTS+7;
	public static final int POT_CRACKED   = POTS+8;
	public static final int POT_EAR   = POTS+9;
	public static final int POT_CALABASH   = POTS+10;
	public static final int POT_RING   = POTS+11;
	static {
		assignItemRect(POT_LONG,        10, 16);
		assignItemRect(POT_WIDE,       16, 12);
		assignItemRect(POT_NARROWMOUTH,   10, 12);
		assignItemRect(POT_GLOBOSE,  10,  11);
		assignItemRect(POT_TRIANGULAR,  12, 11);
		assignItemRect(POT_THINNECK,      10, 12);
		assignItemRect(POT_NORMAL,       10, 12);
		assignItemRect(POT_SMALL, 8, 10);
		assignItemRect(POT_CRACKED, 10, 12);
		assignItemRect(POT_EAR, 12, 12);
		assignItemRect(POT_CALABASH, 10, 13);
		assignItemRect(POT_RING, 12, 13);
	}
	...
	public static final int CARPACCIO   = FOOD+2;
	public static final int BLANDFRUIT  = FOOD+3;
	public static final int SPECIAL_ONIGIRI  = FOOD+4;
	public static final int ONIGIRI      = FOOD+5;
	public static final int BIG_ONIGIRI       = FOOD+6;
	public static final int CHIMAKI = FOOD+7;
	static{
		assignItemRect(MEAT,        15, 11);
		assignItemRect(STEAK,       15, 11);
		assignItemRect(CARPACCIO,   15, 11);
		assignItemRect(BLANDFRUIT,  9,  12);
		assignItemRect(SPECIAL_ONIGIRI,  12, 10);
		assignItemRect(ONIGIRI,      14, 12);
		assignItemRect(BIG_ONIGIRI,       16, 14);
		assignItemRect(CHIMAKI, 16, 14);
	}
	...
	public static final int RAT_SCEPTRE   = QUEST+7;
	static{
		...
		assignItemRect(RAT_SCEPTRE,   13, 12);
	...
	private static void assignItemRect( int item, int width, int height){
		int x = (item % WIDTH) * WIDTH1;
		int y = (item / WIDTH) * WIDTH1;
