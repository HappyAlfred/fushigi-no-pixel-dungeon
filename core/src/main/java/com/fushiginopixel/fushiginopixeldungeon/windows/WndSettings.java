...
import com.fushiginopixel.fushiginopixeldungeon.ui.OptionSlider;
		...
		public DisplayTab() {
			...
			OptionSlider scale = new OptionSlider(Messages.get(this, "scale"),
				...
				protected void onChange() {
					if (getSelectedValue() != SPDSettings.scale()) {
						...
						Fushiginopixeldungeon.switchNoFade((Class<? extends PixelScene>) Fushiginopixeldungeon.scene().getClass(), new Game.SceneChangeCallback() {
							@Override
			...
			CheckBox chkSaver = new CheckBox( Messages.get(this, "saver") ) {
				...
				protected void onClick() {
					...
					if (checked()) {
						checked(!checked());
						Fushiginopixeldungeon.scene().add(new WndOptions(
