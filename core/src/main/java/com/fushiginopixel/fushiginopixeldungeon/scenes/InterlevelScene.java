...
public class InterlevelScene extends PixelScene {
	...
	public void create() {
		...
		if (loadingDepth <= 10)          loadingAsset = Assets.LOADING_SEWERS;
		else if (loadingDepth <= 20)    loadingAsset = Assets.LOADING_PRISON;
		else if (loadingDepth <= 30)    loadingAsset = Assets.LOADING_CAVES;
		else if (loadingDepth <= 41)    loadingAsset = Assets.LOADING_CITY;
		else if (loadingDepth <= 50)    loadingAsset = Assets.LOADING_HALLS;
	...
	public void update() {
		...
		case STATIC:
			if (error != null) {
				...
				Fushiginopixeldungeon.reportException(
