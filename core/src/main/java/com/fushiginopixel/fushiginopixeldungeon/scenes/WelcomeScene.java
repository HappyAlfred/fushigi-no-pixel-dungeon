...
import com.fushiginopixel.fushiginopixeldungeon.effects.Fireball;
...
import com.fushiginopixel.fushiginopixeldungeon.windows.WndStartGame;
...
public class WelcomeScene extends PixelScene {
	...
	private static int LATEST_UPDATE = Fushiginopixeldungeon.v0_6_5;
	...
	public void create() {
		...
		if (Fushiginopixeldungeon.versionCode == previousVersion) {
		...
		DarkRedButton okay = new DarkRedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				if (previousVersion == 0){
					SPDSettings.version(Fushiginopixeldungeon.versionCode);
					WelcomeScene.this.add(new WndStartGame(1));
				} else {
					updateVersion(previousVersion);
					Fushiginopixeldungeon.switchScene(TitleScene.class);
				}
			}
		};
		...
		if (previousVersion != 0){
			DarkRedButton changes = new DarkRedButton(Messages.get(this, "changelist")){
				...
				protected void onClick() {
					super.onClick();
					updateVersion(previousVersion);
					Fushiginopixeldungeon.switchScene(ChangesScene.class);
				}
			};
		...
		} else if (previousVersion <= Fushiginopixeldungeon.versionCode) {
	...
	private void updateVersion(int previousVersion){
		...
		if (previousVersion <= Fushiginopixeldungeon.v0_6_2e){
		...
		if (previousVersion <= Fushiginopixeldungeon.v0_6_0b){
