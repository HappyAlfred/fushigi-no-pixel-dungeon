	...
	public void create() {
		...
		DashboardItem btnBadges = new DashboardItem( Messages.get(this, "badges"), 3 ) {
			...
			protected void onClick() {
				Fushiginopixeldungeon.switchNoFade( BadgesScene.class );
			}
		};
		add(btnBadges);
		...
		DashboardItem btnAbout = new DashboardItem( Messages.get(this, "about"), 1 ) {
			@Override
			protected void onClick() {
				Fushiginopixeldungeon.switchNoFade( AboutScene.class );
			}
		};
		add( btnAbout );
		...
		DashboardItem btnRankings = new DashboardItem( Messages.get(this, "rankings"), 2 ) {
			@Override
			protected void onClick() {
				Fushiginopixeldungeon.switchNoFade( RankingsScene.class );
			}
		};
		add( btnRankings );
