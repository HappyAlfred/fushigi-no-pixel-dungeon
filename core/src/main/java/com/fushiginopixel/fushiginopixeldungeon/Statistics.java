...
public class Statistics {
	...
	private static final String AMULETGOT		= "amuletGot";
	...
	public static void storeInBundle( Bundle bundle ) {
		...
		bundle.put( THIEF,		thief );
		bundle.put( OVERED,		overed );
	}
	...
	public static void restoreFromBundle( Bundle bundle ) {
		...
		thief			= bundle.getBoolean( THIEF );
		overed			= bundle.getBoolean( OVERED );
	}
