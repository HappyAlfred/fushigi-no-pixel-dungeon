...
import com.fushiginopixel.fushiginopixeldungeon.levels.painters.CityPainter;
...
import com.fushiginopixel.fushiginopixeldungeon.levels.traps.DisarmingTrap;
...
import com.fushiginopixel.fushiginopixeldungeon.levels.traps.FlashingTrap;
...
public class CityLevel extends RegularLevel {
	...
	public Class<?>[] trapClasses() {
		return new Class[]{ FrostTrap.class, StormTrap.class, CorrosionTrap.class, BlazingTrap.class, DisintegrationTrap.class,
				ExplosiveTrap.class, RockfallTrap.class, FlashingTrap.class, GuardianTrap.class, WeakeningTrap.class, MucusTrap.class, LogTrap.class,
				SummoningTrap.class, WarpingTrap.class, CursingTrap.class, MultiplicationTrap.class,
