...
public class Terrain {
	...
	public static final int DESTRUCTABLE	= 0x100;
	
	public static final int[] flags = new int[256];
	static {
		flags[CHASM]		= AVOID	| PIT;
		flags[EMPTY]		= PASSABLE;
		flags[GRASS]		= PASSABLE | FLAMABLE | DESTRUCTABLE;
		flags[EMPTY_WELL]	= PASSABLE;
		flags[WATER]		= PASSABLE | LIQUID;
		flags[WALL]			= LOS_BLOCKING | SOLID | DESTRUCTABLE;
		flags[DOOR]			= PASSABLE | LOS_BLOCKING | FLAMABLE | SOLID | DESTRUCTABLE;
		flags[OPEN_DOOR]	= PASSABLE | FLAMABLE | DESTRUCTABLE;
		...
		flags[BARRICADE]	= FLAMABLE | SOLID | LOS_BLOCKING | DESTRUCTABLE;
		flags[EMPTY_SP]		= flags[EMPTY];
		flags[HIGH_GRASS]	= PASSABLE | LOS_BLOCKING | FLAMABLE | DESTRUCTABLE;
		...
		flags[SIGN]			= PASSABLE | FLAMABLE | DESTRUCTABLE;
		flags[WELL]			= AVOID;
		flags[STATUE]		= SOLID | DESTRUCTABLE;
