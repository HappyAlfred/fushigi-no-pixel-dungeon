...
import com.fushiginopixel.fushiginopixeldungeon.levels.painters.HallsPainter;
...
import com.fushiginopixel.fushiginopixeldungeon.levels.traps.DistortionTrap;
...
public class HallsLevel extends RegularLevel {
	...
	public Class<?>[] trapClasses() {
		return new Class[]{ FrostTrap.class, StormTrap.class, CorrosionTrap.class, BlazingTrap.class, DisintegrationTrap.class,
				...
				SummoningTrap.class, WarpingTrap.class, CursingTrap.class, GrimTrap.class, MultiplicationTrap.class,
