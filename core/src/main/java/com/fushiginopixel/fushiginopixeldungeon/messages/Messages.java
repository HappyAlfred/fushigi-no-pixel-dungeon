...
package com.fushiginopixel.fushiginopixeldungeon.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.fushiginopixel.fushiginopixeldungeon.messages.actors.actors",
			"com.fushiginopixel.fushiginopixeldungeon.messages.items.items",
			"com.fushiginopixel.fushiginopixeldungeon.messages.journal.journal",
			"com.fushiginopixel.fushiginopixeldungeon.messages.levels.levels",
			"com.fushiginopixel.fushiginopixeldungeon.messages.plants.plants",
			"com.fushiginopixel.fushiginopixeldungeon.messages.scenes.scenes",
			"com.fushiginopixel.fushiginopixeldungeon.messages.ui.ui",
			"com.fushiginopixel.fushiginopixeldungeon.messages.windows.windows",
			"com.fushiginopixel.fushiginopixeldungeon.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.fushiginopixel.fushiginopixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
